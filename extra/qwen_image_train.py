...
def start_training_qwen_image(
    ...
    with open("config/examples/run/train_lora_qwen_image.yaml", "r") as f:
...
def main(dataset_path: str):
    start_training_qwen_image("lora_test01", "lora", "zrn", 4800, 1e-4, 16, -1, True, dataset_path, "[]")
    return None
