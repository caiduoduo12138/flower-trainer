...
def start_training_qwen_image_2512(
    exp_name: str,
    target_type: str,
    ...
    with open("config/examples/run/train_lora_qwen_image_2512.yaml", "r") as f:
...
def main(dataset_path: str):
    start_training_qwen_image_2512("lora_test01", "lora", "zrn", 4800, 1e-4, 16, -1, True, dataset_path, "[]")
    return None
