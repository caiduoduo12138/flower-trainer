...
def start_training_z_image_base(
    exp_name: str,
    target_type: str,
    ...
    with open("config/examples/run/train_lora_z_image_base.yaml", "r") as f:
...
def main(dataset_path: str):
    start_training_z_image_base("lora_test01", "lora", "zrn", 4800, 1e-4, 16, 4, True, dataset_path, "[]")
    return None
