...
def start_training_qwen_image_edit_2509(
    exp_name: str,
    target_type: str,
    ...
    with open("config/examples/run/train_lora_qwen_image_edit_2509.yaml", "r") as f:
...
def main(dataset_path: str, control_data: list):
    start_training_qwen_image_edit_2509("lora_test01", "lora", "zrn", 4800, 1e-4, 16, 4, True, dataset_path, str(control_data), "[]")
    return None
